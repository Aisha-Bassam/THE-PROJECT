...
# ── 3. SAMPLE FOR SPEED (remove this later for full training) ─────────────────
...
# ── 6. SAVE MODELS ────────────────────────────────────────────────────────────
joblib.dump(models, 'ML/rf_models.pkl')
print("\nModels saved to ML/rf_models.pkl")

# ── 7. SHAP ON A SMALL SAMPLE ─────────────────────────────────────────────────
# We run SHAP on 100 rows — enough to see it working without taking forever
