...
# ── 5. TRAIN ONE GBR PER TARGET ───────────────────────────────────────────────
# WARNING: GradientBoostingRegressor is slower than RF — this will take longer
models = {}

for target in target_cols:
    print(f"\nTraining GBR for: {target}")
...
# ── 6. SAVE MODELS ────────────────────────────────────────────────────────────
joblib.dump(models, 'ML/gbr_models.pkl')
print("\nModels saved to ML/gbr_models.pkl")
